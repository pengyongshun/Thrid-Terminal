...
//    };
    ...
    /**
     * Set the icon_shadow_bg gradient color
     * 
     * @param start
     * @param middle
     * @param end
    ...
    private void drawShadows(Canvas canvas) {
        ...
        // */
        topShadow.setBounds(0, 0, getWidth(), height - getItemHeight());
        topShadow.draw(canvas);

        bottomShadow.setBounds(0, getHeight() - height + getItemHeight(), getWidth(), getHeight());
