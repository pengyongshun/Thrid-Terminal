...
public class CaptureSipCallback extends CaptureSipCallbackAdapter {
	...
	public CaptureSipCallback(Handler handler) {
		mHandler = handler;
	}

	@Override
	public void onCaptureRegisterStatus(boolean success) {
		// 注册成功上报绑定关系
		if (success) {
	...
	@Override
	public void onCaptureReceivePlay(String sessionId) {

		mHandler.obtainMessage(ON_RECEIVE_PLAY, sessionId).sendToTarget();
	}
	
	@Override
	public void onCapturePlaySuccess(String sessionId) {

		mHandler.obtainMessage(ON_PLAY_SUCCESS, sessionId).sendToTarget();
	}

	@Override
	public void onCapturePlayFail(String sessionId) {

		mHandler.obtainMessage(ON_PLAY_FAIL, sessionId).sendToTarget();
	}

	@Override
	public void onCaptureReceiveBye(String sessionId) {
